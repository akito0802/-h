...
(function(){
  ...
  "ドリアン": "マイナーコード上で明るさを持たせたい時に有効。II-7でよく使われる。",
  "フリジアン": "スペイン風・中東風の雰囲気を出す時やbIIメジャーとの絡みに。",
  "リディアン": "メジャーコード上で#11テンションを自然に使える。IVメジャーで映える。",
  "ミクソリディアン": "ドミナント7コード上で使う王道スケール。",
  "ロクリアン": "m7♭5コード上で使う。IIø7やハーフディミニッシュに。",
  "リディアン・ドミナント（Mixolydian #11）": "ドミナント7(#11)コードに適したスケール。リディアン由来の#11が特徴で、IV7やV7に用いるとジャズ的な広がりと緊張感を加えられる。特にサブドミナントマイナー進行やトライトーン代理にも有効。",
  "アルタード（Super Locrian）": "V7altコード専用スケール。♭9, #9, ♭5, #5といったテンションをすべて含み、解決先に強烈な推進力を持たせる。アウト寄りのアプローチやモーダルインターチェンジにも応用可能。",
  "ホールトーン": "全音のみで構成された対称スケール。オーギュメントコードやオーギュメント化したV7で使うと、浮遊感や非機能的な響きを演出できる。印象的なライン作りに効果的。",
  "ディミニッシュ（H-W）": "半音→全音の順で構成。V7(b9, #9)に適し、特にトライトーン解決直前に使用される。対称構造を活かしてシーケンス的なフレーズに展開できる。",
  "ディミニッシュ（W-H）": "全音→半音の順で構成。ディミニッシュ7コードそのもの、あるいはV7♭9からの解決に用いる。H-W型とセットで覚えると運用の幅が広がる。",
  "フリジアン・ドミナント": "ハーモニックマイナー由来のスケールで、V7♭9に適用。エスニックで緊張感のある響きを持ち、ラテン系やモーダル楽曲で映える。",
  "ミクソリディアン♭13": "V7♭13やIV7で使用可能。ブルース感とジャズ感を融合した響きになり、コード進行に個性を加える。",
  "リディアン・オーギュメント": "メジャー7(#5)コード上に最適。メジャーとオーギュメントの両方の性質を持ち、浮遊感と緊張感を両立させる。",
  "ベバップ・ドミナント": "Mixolydianにメジャー7を加えた8音スケール。スイング感のあるフレーズや、コードトーン着地を意識したライン作りに役立つ。",
  "ベバップ・メジャー": "Ionianに♭6を加えたスケール。II-V-IのIメジャーで使うと、アプローチノート的な機能を持つ。",
  "ドリアン♭2": "マイナーコードに適用可能だが、特にbII解決やエスニックな響きが必要な場面で映える。"
};
